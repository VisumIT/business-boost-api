...
public class CompanyDTO {
	...
	// recebe uma lista de companies e retorna uma lista de companiesDTO para
	// facilitar a listagem
	...
	// retorna company sem funcionario para não expor informações criticas para o
	// representante
